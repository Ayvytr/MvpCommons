...
public class CornerLabelView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < ta.getIndexCount(); i++) {
            ...
            } else if (attr == R.styleable.CornerLabelView_android_textSize) {
                textSize = ta.getDimensionPixelSize(attr, textSize);
            } else if (attr == R.styleable.CornerLabelView_android_textColor) {
                textColor = ta.getColor(attr, textColor);
            } else if (attr == R.styleable.CornerLabelView_android_text) {
