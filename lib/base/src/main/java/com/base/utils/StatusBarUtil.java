...
//      window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
    ...
    public static int setLightMode(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                result = 1;
            } else if (setFlymeLightMode(activity.getWindow(), true)) {
                result = 2;
    ...
    public static void setLightMode(Activity activity, int type) {
        if (type == 1) {
            ...
            setFlymeLightMode(activity.getWindow(), true);
        } else if (type == 3) {
            activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
        }
    ...
    public static void setDarkMode(Activity activity, int type) {
        if (type == 1) {
            ...
            setFlymeLightMode(activity.getWindow(), false);
        } else if (type == 3) {
     ...
     */
    public static boolean setFlymeLightMode(Window window, boolean dark) {
